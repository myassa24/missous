...
SET _JRE_CANDIDATE=
IF "%JRE%" == "" IF EXIST "%APPDATA%\JetBrains\PyCharmCE2024.3\pycharm64.exe.jdk" (
  SET /P _JRE_CANDIDATE=<"%APPDATA%\JetBrains\PyCharmCE2024.3\pycharm64.exe.jdk"
)
IF "%JRE%" == "" (
...
SET IDE_CACHE_DIR=%LOCALAPPDATA%\JetBrains\PyCharmCE2024.3
...
IF "%USER_VM_OPTIONS_FILE%" == "" (
  ...
  ) ELSE IF EXIST "%APPDATA%\JetBrains\PyCharmCE2024.3\pycharm64.exe.vmoptions" (
    SET "USER_VM_OPTIONS_FILE=%APPDATA%\JetBrains\PyCharmCE2024.3\pycharm64.exe.vmoptions"
  )
)
